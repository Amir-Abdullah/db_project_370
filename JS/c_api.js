...
const displayPhoneDetail = (details) => {
    ...
    <img src="${details.image}" class="card-img-top mx-auto d-block w-50 my-2" alt="...">
        ...
        <ul class="list-group list-unstyled">
            ...
            <li class="d-flex flex-row-reverse mt-2 align-items-center">
                <button type="button" class="order-1 mx-1 w-25 btn btn-lg btn-primary">Buy Now</button>
                <h6 class="order-3 mx-1 d-flex section-title ">Quantity</h6>
                <div class="order-2 mx-1">
                    <input type="text" step="1" min="1" max="5" autocomplete="off" height="100%" width="5" placeholder="In Stock: ">
                </div>
            </li>
        </ul>
    </div>
